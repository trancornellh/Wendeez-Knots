...
<body>
    ...
    <div class="cointainer" style="margin-top: 50px; background-color: #EEE1C6; height: 400px">
        <div class="row">
            <div class="col-3">
                <img src="Images/giannis-holdingtrophy.jpg" id="playoff">
            </div>
            <div class="col">
                <h1>NBA PLAYOFF</h1>
                <p>Bucks fans!</p>
                <p>The playoffs are here. From the tip off the final buzzer, we got you covered.</p>
                <p>Enjoy $0 delivery fee</p>
            </div>
        </div>
    </div>
